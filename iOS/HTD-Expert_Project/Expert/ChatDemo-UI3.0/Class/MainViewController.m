...
#endif
{
    ...
    ExpertViewController *_expertVC;
...
- (void)tabBar:(UITabBar *)tabBar didSelectItem:(UITabBarItem *)item
{
    if (item.tag == 0) {
        ...
        self.title = NSLocalizedString(@"Expert", @"Expert");
        self.navigationItem.rightBarButtonItem = nil;
    }else if (item.tag == 3){
...
- (void)setupSubviews
{
    ...
    _expertVC = [[ExpertViewController alloc] initWithNibName:nil bundle:nil];
    _expertVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"Expert", @"Expert")
                                                           image:nil
                                                             tag:2];
    [_expertVC.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"tabbar_contactsHL"]
                         withFinishedUnselectedImage:[UIImage imageNamed:@"tabbar_contacts"]];
    [self unSelectedTapTabBarItems:_expertVC.tabBarItem];
    [self selectedTapTabBarItems:_expertVC.tabBarItem];
    ...
    self.viewControllers = @[_chatListVC, _contactsVC, _expertVC, _settingsVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}
